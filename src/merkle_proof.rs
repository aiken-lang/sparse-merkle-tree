...
impl MerkleProof {
    ...
    pub fn compile(self, _leaves_keys: Vec<H256>) -> Result<CompiledMerkleProof> {
        todo!()
    }
            ...
            match code {
                ...
                0x50 => {
                    ...
                    let parent = if key.get_bit(height) {
                        merge::<H>(&sibling_node, &value)
                    } else {
                        merge::<H>(&value, &sibling_node)
                    };
                ...
                0x4F => {
                    ...
                    for idx in 0..zero_count {
                        ...
                        value = if key.get_bit(height) {
                            merge::<H>(&MergeValue::zero(), &value)
                        } else {
                            merge::<H>(&value, &MergeValue::zero())
                        };
                    }
